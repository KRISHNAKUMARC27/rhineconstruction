...
import StatsIllustrationSrc from "images/stats-cart.jpg";
...
export default ({
  ...
  description = "Our impeccable track record speaks to our unwavering commitment to excellence and consistent delivery of top-quality construction projects.",
